<?php /* Smarty version 2.6.26, created on 2010-10-24 12:26:11
         compiled from F:/Apache2.2/htdocs/ta_portal_dev/templates/payment/order_pay_script.tpl */ ?>
   		   ...
   		   var cardType="";
	   		   ...
	   		   if(value==3 || value==4 || value==2){  
	   				...
	   				if($('#expressName').val()==null || $('#expressName').val()==''){
						...
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['name_prompt']; ?>
');	
	   				}else if($('#expressAddressLine').val()==null || $('#expressAddressLine').val()==''){
	   					$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['address_prompt']; ?>
');	
	   				}else if($('#expressPostcode').val()==null || $('#expressPostcode').val()==''){
	   					$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['postalcode_prompt']; ?>
');	
	   				}else if($('#expressEmail').val()==null || $('#expressEmail').val()==''){
	   					$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['email_prompt']; ?>
');	
	   				}else if($('#expressFixedPhone').val()==null || $('#expressFixedPhone').val()==''){
	   					$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['phone_prompt']; ?>
');	
	   				}else if (!emailRegExp.test($('#expressEmail').val())||$('#expressEmail').val().indexOf('.')==-1){
						$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['wrong_eamil']; ?>
');	
					}else if($('#expressMobilePhone').val()==null || $('#expressMobilePhone').val()==''){
	   					$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['mobile_phone_prompt']; ?>
');	
	   				}else if (!pattern.exec($('#expressMobilePhone').val())){
						$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['input_mobile_phone']; ?>
');	
					}else if (!pattern.test($('#expressFixedPhone').val())){
						$('#expressErrorMessage').show();
						$('#expressErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['input_phone']; ?>
');	
					}else{
					...
					if($('#paymentType').val()=='CreditCard'){
					   		...
					   		if($('#holder_name').val()==null || $('#holder_name').val()==''){
					   			$('#errorDiv').show();
								$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['input_card_name']; ?>
');	
								validation=false;
					   		}else{
								...
								case 0:
									$('#errorDiv').show();
									$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['input_credit_card_num']; ?>
');	
									validation=false;
									break;
								case 1:
									$('#errorDiv').show();
									$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['choose_year_prompt']; ?>
');	
									validation=false;
									break;
								case 2:
									$('#errorDiv').show();
									$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['year_invalid']; ?>
');	
									validation=false;
									break;
								case 3:
									$('#errorDiv').show();
									$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['card_invalid']; ?>
');	
									validation=false;
									break;
								case 4:
								...
								case 5:
									$('#errorDiv').show();
									$('#errorDiv').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['credit_card_num_prompt']; ?>
');	
									validation=false;
									break;
								case 6:
						...
						newAddress=newAddress+$('#expressAddressLine').val();
	   					...
	   					pt_code:cardType}, function(message) {
							...
							if (parseInt(msg_arr[0]) == parseInt(0)) {
								...
								<?php if ($this->_tpl_vars['param_list']['payment_gateway_type'] == 'payease'): ?>
								...
								<?php elseif ($this->_tpl_vars['param_list']['payment_gateway_type'] == 'asiapay'): ?>
								...
								alert("<?php echo $this->_tpl_vars['LANG']['order_pay']['order_error']; ?>
");
								window.location.href='<?php echo $this->_tpl_vars['rootpath']; ?>
/<?php echo $this->_tpl_vars['module']; ?>
/choose_seat.php?show_id='+<?php echo $this->_tpl_vars['param_list']['show_id']; ?>
;
								//history.back();
							}
						});
						...
						$('#unifyErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['name_prompt']; ?>
');	
	   				}else if($('#unifyEmail').val()==null || $('#unifyEmail').val()==''){
	   					$('#unifyErrorMessage').show();
						$('#unifyErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['email_prompt']; ?>
');	
	   				}else if($('#unifyMobilePhone').val()==null || $('#unifyMobilePhone').val()==''){
	   					$('#unifyErrorMessage').show();
						$('#unifyErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['mobile_phone_prompt']; ?>
');	
	   				}else if (!emailRegExp.test($('#unifyEmail').val())||$('#unifyEmail').val().indexOf('.')==-1){
						$('#unifyErrorMessage').show();
						$('#unifyErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['wrong_eamil']; ?>
');	
					}else if (!pattern.exec($('#unifyMobilePhone').val())){
						$('#unifyErrorMessage').show();
						$('#unifyErrorMessage').append('<?php echo $this->_tpl_vars['LANG']['order_pay']['input_mobile_phone']; ?>
');	
					}else{
						if($('#paymentType').val()=='CreditCard'){
					   		cardType=$("#cardType").val();
...
==$("#country_id").find("option:selected").val()){
							$("#expressFixedPhoneCode").val(<?php echo $this->_tpl_vars['rs']['code']; ?>
);
							$("#expressMobilePhoneCode").val(<?php echo $this->_tpl_vars['rs']['code']; ?>
);
...
==$("#city_"+country_id).find("option:selected").val()){
								$("#expressFixedPhoneAreaCode").val(<?php echo $this->_tpl_vars['rs']['code']; ?>
);
