<?php /* Smarty version 2.6.26, created on 2010-11-09 08:53:46
         compiled from E:/Apache2.2/htdocs/ta_portal_dev/templates/payment/asiapay_wait_cp.tpl */ ?>
...
<FORM name="asiapay_cp" method="POST" action="<?php echo $this->_tpl_vars['action_url']; ?>
">
...
" >
	<input type="hidden" name="payMethod" value="<?php echo $this->_tpl_vars['payMethod']; ?>
" >
...
">
	<input type="hidden" name="cancelUrl" value="<?php echo $this->_tpl_vars['cancelUrl']; ?>
">
