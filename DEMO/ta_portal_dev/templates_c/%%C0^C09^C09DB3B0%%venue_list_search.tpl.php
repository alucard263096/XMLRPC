<?php /* Smarty version 2.6.26, created on 2010-11-09 07:29:52
         compiled from E:/Apache2.2/htdocs/ta_portal_dev/templates/movie/venue_list_search.tpl */ ?>
...
/images/search_bg.gif"><input name="textfield2" type="text" class="formsearch130" id="keyword"></td>
                    <td><a href="javascript:void(0)" onclick="searchMovie()"><img src="<?php echo $this->_tpl_vars['rootpath']; ?>
/images/button_quick_search.gif" width="30" height="20" border="0"></a></td>
                  </tr>
                </table></td>
                <td>&nbsp;</td>
                <td width="110"><label>
                	<select name="select2" class="form100px" id="venue"  onChange="changeVenue(this)">
		    			<option value="v-1"><?php echo $this->_tpl_vars['LANG']['venue_list']['cinemas']; ?>
</aption>	
...
" style="background-color:#9E0D44 ;"><?php echo $this->_tpl_vars['circuit']['name']; ?>
    ...
    foreach ($_from as $this->_tpl_vars['venue2']):
?>				        		
					        		<option value="v<?php echo $this->_tpl_vars['venue2']['venue_id']; ?>
"><?php echo $this->_tpl_vars['venue2']['name']; ?>
</option>
					        <?php endforeach; endif; unset($_from); ?>
				   		<?php endforeach; endif; unset($_from); ?>
				   		</select>
                ...
                <td width="130"><label>
                	<select name="select3" class="form140px" id="activity_id"  style="font-size:12px"   onChange="changeMovie()">
				        <option value="-1"><?php echo $this->_tpl_vars['LANG']['venue_list']['selectbroadcastmovie']; ?>
</aption>	
