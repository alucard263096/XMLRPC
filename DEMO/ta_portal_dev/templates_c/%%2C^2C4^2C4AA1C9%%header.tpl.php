<?php /* Smarty version 2.6.26, created on 2010-11-05 06:15:49
         compiled from E:/Apache2.2/htdocs/ta_portal_dev/templates/header.tpl */ ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><?php if ($this->_tpl_vars['domain'] == 'ticketchina'): ?>TicketChina - 网罗演唱会、电影、体育、交通、酒店等抢手门票，一站式娱乐旅游消闲网页<?php else: ?>TicketAsia - 網羅演唱會、電影、體育、交通、酒店等搶手門票，一站式娛樂旅遊消閒網頁<?php endif; ?></title>
										...
										<td align="right" colspan="2">
											<!--==============//////    Start Login  Menu  \\\\\\=========== -->
												<?php if ($_SESSION['member'] != ''): ?>
													...
													<?php if ($_SESSION['member']['first_name'] <> '' || $_SESSION['member']['last_name'] <> ''): ?>
														<?php echo $_SESSION['member']['first_name']; ?>
 <?php echo $_SESSION['member']['last_name']; ?>

													<?php elseif ($_SESSION['member']['nickname'] <> ''): ?>
														<?php echo $_SESSION['member']['nickname']; ?>

													<?php else: ?>
														<?php echo $_SESSION['member']['login_name']; ?>
...
/member/register_user.php" class="toplink"><?php echo $this->_tpl_vars['LANG']['header']['member_register']; ?>
												...
												<?php endif; ?>
												&nbsp;&nbsp;&nbsp;
												<?php if ($this->_tpl_vars['lang'] == 'en-us'): ?>
...
<?php if ($this->_tpl_vars['file_url_parameter'] != ""): ?>&<?php endif; ?>lang=zh-sc"><?php echo $this->_tpl_vars['LANG']['header']['zh_sc']; ?>
						                    	...
						                    	<?php elseif ($this->_tpl_vars['lang'] == 'zh-sc'): ?>
						                    	<a href="<?php echo $this->_tpl_vars['file_url']; ?>
?<?php echo $this->_tpl_vars['file_url_parameter']; ?>
<?php if ($this->_tpl_vars['file_url_parameter'] != ""): ?>&<?php endif; ?>lang=zh-tc"><?php echo $this->_tpl_vars['LANG']['header']['zh_tc']; ?>
</a> | 
						                    	<a href="<?php echo $this->_tpl_vars['file_url']; ?>
?<?php echo $this->_tpl_vars['file_url_parameter']; ?>
<?php if ($this->_tpl_vars['file_url_parameter'] != ""): ?>&<?php endif; ?>lang=en-us"><?php echo $this->_tpl_vars['LANG']['header']['en_us']; ?>
</a>
						                    	<?php else: ?>
						                    	<a href="<?php echo $this->_tpl_vars['file_url']; ?>
?<?php echo $this->_tpl_vars['file_url_parameter']; ?>
...
/images/nav_box1_o.gif" alt="" border="0" class="b"></a>
															...
															<?php if ($_SESSION['city_id'] <> $this->_tpl_vars['hk_city_id']): ?>
																<td <?php if ($this->_tpl_vars['param_list']['category_id'] <> $this->_tpl_vars['movie_category_id']): ?>onMouseOver="showmenu('navi')" onMouseOut="hidemenu('navi')"<?php endif; ?>>
																	<div class="menu1">
...
/nav_sub1_04_on.gif',1)" onMouseOut="MM_swapImgRestore()" border="0"></a></td>//-->
						                					...
						                					<?php endif; ?>
						                						<td <?php if ($this->_tpl_vars['param_list']['category_id'] <> $this->_tpl_vars['show_category_id']): ?> onMouseOver="showmenu('nav2')" onMouseOut="hidemenu('nav2')" <?php endif; ?>>
							                						<div class="menu1">
							                							<a href="<?php echo $this->_tpl_vars['rootpath']; ?>
...
/nav_sub4_05_on.gif',1)" onMouseOut="MM_swapImgRestore()" border="0"></a></td>
												                ...
												                <td onMouseOver="showmenu('nav5')" onMouseOut="hidemenu('nav5')"><div class="menu1"><a href="<?php echo $this->_tpl_vars['rootpath']; ?>
...
/nav_05_on.gif" alt="" border="0" class="b"></a></div>
												                ...
												                <td onMouseOver="showmenu('nav6')" onMouseOut="hidemenu('nav6')"><div class="menu1"><a href="<?php echo $this->_tpl_vars['rootpath']; ?>
