    ...
    <td align="center">
      ...
      <tr>
        ...
        <table width="730" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" valign="top" background="<{$rootpath}>/images/line_movie_bg.gif"><img src="<{$rootpath}>/images/<{$lang}>/table_movie_list.gif"></td>
          </tr>
          <tr>
            <td valign="top">&nbsp;</td>
          </tr>
          ...
          <!-- red bar-->
          <tr>
            <td height="35" background="<{$rootpath}>/images/bg_bar_red.gif">
           <!-- div2_load-->
            <div width="730">
        ...
        <table width="205" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><img src="<{$rootpath}>/images/<{$lang}>/movie_rightbox_title4.gif" width="205" height="45"></td>
          </tr>
          <tr>
            <td align="center" background="<{$rootpath}>/images/movie_rightbox_205bg.gif">
            <{include file="$smarty_root/event_common/rank.tpl" }>
            </td>
          </tr>
          
          <tr>
            <td><img src="<{$rootpath}>/images/movie_rightbox_bottom.gif" width="205" height="7"></td>
          </tr>
        </table>
        <table width="205" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <tr>
            <td><img src="<{$rootpath}>/images/<{$lang}>/movie_rightbox_title5.gif" width="205" height="45"></td>
          </tr>
          <tr>
            <td align="center" background="<{$rootpath}>/images/movie_rightbox_205bg.gif"><table width="190" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="25"><img src="<{$rootpath}>/images/icon_list_arrow.gif" width="17" height="17"></td>
                <td class="movietable_right_5pxguid"><a href="#" class="blklink">玩具总动员3（3D版）</a></td>
              </tr>
              <tr>
                <td><img src="<{$rootpath}>/images/icon_list_arrow.gif" width="17" height="17"></td>
                <td class="movietable_right_5pxguid"><a href="#" class="blklink">玩具总动员3（3D版）</a></td>
              </tr>
              <tr>
                <td><img src="<{$rootpath}>/images/icon_list_arrow.gif" width="17" height="17"></td>
            ...
            <table width="190" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right" class="movietable_right_5pxguid"><a href="#" class="moviemorelink">+More&gt;&gt;</a></td>
                  </tr>
              </table>
             </td>
          </tr>
...
<script type="text/javascript">	
	...
	$(function() {
		...
		$('#div2').load("venue_list.php", {"action":"resetLocation"}, function() {
			$('#div2').css('display','');
			$('#div2_load').css('display','none');			
		    
		});
		$('#div3').load("venue_list.php", {"action":"resetCriteria"}, function() {
			$('#div3').css('display','');
		...
		$.fn.studyplay_star=function(options,callback){
			...
			.find('.studyplay_starON').hover(function(){
							...
							$.post("venue_list.php", {"action":"vote","score":studyplay_count,"venue_id":id}, function(message) {
