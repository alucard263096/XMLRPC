...
////////////////// No Editing Required //////////////////
if(!document.getElementById(id)||(!id&&!document.getElementById(id))) return;
...
if(!id||!document.getElementById(id)||(typeof id=='string'&&!document.getElementById(id).parentNode)||(typeof id=='object'&&!id.parentNode))return;
