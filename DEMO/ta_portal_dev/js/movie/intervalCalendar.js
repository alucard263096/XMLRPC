	...
	function setDateTxt(date1,date2){
		YAHOO.util.Event.onDOMReady(function() {
		    var inTxt = YAHOO.util.Dom.get("check_in_date"),
		        outTxt = YAHOO.util.Dom.get("check_out_date"),
		        inDate, outDate, interval;
		
		    inTxt.value = date1;
		    outTxt.value = date2;
		
		    var cal = new YAHOO.example.calendar.IntervalCalendar("cal1Container", {pagedate:new Date(),mindate:new Date(),pages:2});
