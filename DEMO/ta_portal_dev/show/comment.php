 ...
 */
	...
	$param_list = isset($_SESSION['comment']['param_list'])?$_SESSION['comment']['param_list']:array();
	...
	$_SESSION['comment']['param_list'] = $param_list;
	$smarty->assign("lang",$_SESSION["lang"]);
	$smarty->assign("param_list", $param_list);
	$smarty->display(ROOT.'/templates/show/comment.tpl');
